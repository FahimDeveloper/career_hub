...
const SingleAppliedJob = (props) => {
    ...
    return (
        <div className='border border-slate-200 p-5 rounded-lg space-y-4 flex items-center justify-between'>
            <div className='flex items-center gap-20'>
                <div className='bg-gray-200 h-44 w-44 flex justify-center items-center'>
